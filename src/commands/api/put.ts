...
export default class ApiPut extends BaseCommand {
  public static override description = 'Call any ServiceTitan PUT endpoint directly'
  ...
  public async run(): Promise<void> {
    ...
    if (flags['dry-run']) {
      printDryRun('PUT', resolvedPath, body)
      return
    }

    const confirmed = await confirmAction(`Send PUT to ${resolvedPath}?`, flags.yes ?? false)
